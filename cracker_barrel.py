...
def process_future_result(future, flag):
...
def futures_handler(future, flag, total_count, start_time, summary):
    match_found, chunk_count, password = process_future_result(future, flag)
